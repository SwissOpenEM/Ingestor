...
func (r *taskRow) Refresh() {
	...
	r.progress.SetValue(float64(d.BytesTransferred / d.BytesTotal))
...
func (p PsiTheme) Color(name fyne.ThemeColorName, variant fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameBackground:
		return color.RGBA{39, 170, 200, 1} // dark navy
	case theme.ColorNameForeground:
		return color.Color(color.White) // light grey-white
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0x38, G: 0xbd, B: 0xb3, A: 0xff} // teal accent
	case theme.ColorNameButton:
		return color.NRGBA{R: 0x2a, G: 0x2f, B: 0x45, A: 0xff} // card surface
